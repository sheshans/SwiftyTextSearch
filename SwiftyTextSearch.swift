...
//
////Supports Archive
//print((NSKeyedArchiver.archivedData(withRootObject: newObj) as NSData).length / 1024  )
//
////To Search
//print("Searching \"mobil\"")
//let currentTime = CACurrentMediaTime()
//print(newObj.searchText(searchString: "mobil"))
//let responseTime = Int((CACurrentMediaTime() - currentTime) * 1000)
//print(responseTime)
//
////To Delete
//print("Deleting \"xyz Mobiles\"")
//let currentTime1 = CACurrentMediaTime()
//newObj.delete(titles: Set(["xyz Mobiles"]))
//let responseTime1 = Int((CACurrentMediaTime() - currentTime1) * 1000)
//print(responseTime)
//
////To Search
//print("Searching \"mobil\"")
//let currentTime2 = CACurrentMediaTime()
//print(newObj.searchText(searchString: "mobil"))
//let responseTime2 = Int((CACurrentMediaTime() - currentTime2) * 1000)
//print(responseTime)
//
//
////To Add
//print("Adding \"xyz Mobiles\"")
//let currentTime3 = CACurrentMediaTime()
//print(newObj.appendStrings(arr: ["xyz Mobiles"]) )
//let responseTime3 = Int((CACurrentMediaTime() - currentTime3) * 1000)
//print(responseTime)
//
////To Search
//print("Searching \"mobil\"")
//let currentTime4 = CACurrentMediaTime()
//print(newObj.searchText(searchString: "mobil"))
//let responseTime4 = Int((CACurrentMediaTime() - currentTime4) * 1000)
//print(responseTime)
//
//
//
